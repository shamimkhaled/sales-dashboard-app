        ...
        >
          <motion.div variants={itemVariants}>
            <KPICard
              ...
              trendValue={`${kpiData.totalRevenueChange >= 0 ? "+" : ""}${
                kpiData.totalRevenueChange
              }%`}
            />
          </motion.div>
          <motion.div variants={itemVariants}>
            <KPICard
              ...
              trendValue={`${kpiData.totalCustomersChange >= 0 ? "+" : ""}${
                kpiData.totalCustomersChange
              }%`}
            />
          </motion.div>
          <motion.div variants={itemVariants}>
            <KPICard
              ...
              trendValue={`${kpiData.activeCustomersChange >= 0 ? "+" : ""}${
                kpiData.activeCustomersChange
              }%`}
            />
          </motion.div>
          <motion.div variants={itemVariants}>
            <KPICard
              ...
              trendValue={`${kpiData.collectionRateChange >= 0 ? "+" : ""}${
                kpiData.collectionRateChange
              }%`}
            />
          </motion.div>
        </motion.div>
                ...
                <tbody>
                  {kamPerformanceData.map((kam, idx) => (
                    ...
                    >
                      ...
                      >
                        ৳{kam.total_revenue?.toLocaleString()}
                      </td>
                      <td
                        className={`px-4 py-3 text-sm text-right ${
                          isDark ? "text-silver-300" : "text-gray-700"
                      ...
                      >
                        ৳
                        {(
                          kam.total_revenue / kam.total_customers
