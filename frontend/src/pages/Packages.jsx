              ...
              >
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Chanel Partner / Franchise">Chanel Partner / Franchise</option>
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">Mbps</label>
                  <input
                    type="number"
                    name="mbps"
                    value={formData.mbps}
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    <option value="">Select Type</option>
                    <option value="MAC Package">MAC Package</option>
            ...
            <table className="w-full">
              ...
              <tbody>
                {packages.map((pkg) => (
                  ...
                  >
                    <td className="px-6 py-4 text-sm font-medium">{pkg.name}</td>
                    <td className="px-6 py-4 text-sm">{pkg.type}</td>
                    <td className="px-6 py-4 text-sm">{pkg.mbps || "N/A"}</td>
                    ...
                    <div>
                      ...
                      >
                        {viewingPackage.price
                          ? `$${parseFloat(viewingPackage.price).toFixed(2)}`
                          : "N/A"}
                      </p>
                    </div>
                  </div>
