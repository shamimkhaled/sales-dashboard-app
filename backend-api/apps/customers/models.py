...
class CustomerMaster(models.Model):
    ...
    free_giveaway_client = models.IntegerField(default=0, blank=True, null=True, help_text="MAC only")
    default_percentage_share = models.DecimalField(max_digits=5, decimal_places=2, default=0, blank=True, null=True, help_text="MAC only")
